...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """user""", """controllers.UserController.getUser"""),
  ...
  // @LINE:10
  private[this] lazy val controllers_UserController_getUser3_route = Route("GET",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:10
    case controllers_UserController_getUser3_route(params@_) =>
      call { 
        controllers_UserController_getUser3_invoker.call(UserController_2.getUser)
      }
